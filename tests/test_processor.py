...
class TestCandlestickPatterns(unittest.TestCase):
    ...
    def test_evening_star(self):
        ...
        prev_prev_data = {"open": 145, "high": 148, "low": 144, "close": 147}
        prev_data = {"open": 148, "high": 150, "low": 146, "close": 149}
        data = {
            "symbol": "AAPL",
            "timestamp": "2025-02-22T14:30:00Z",
            "price": 140.0,
    ...
    def test_three_black_crows(self):
        ...
        prev_prev_data = {"open": 150, "high": 152, "low": 148, "close": 149}
        prev_data = {"open": 149, "high": 150, "low": 146, "close": 147}
        data = {
            "symbol": "AAPL",
            "timestamp": "2025-02-22T14:30:00Z",
            "price": 145.0,
