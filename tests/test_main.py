...
class TestMain(unittest.TestCase):
    ...
    def test_rabbitmq_message_consumption(self, mock_consume_messages):
        ...
        mock_consume_messages.return_value = None  # Simulate successful message processing
        result = main()
    ...
    def test_rabbitmq_connection_failure(self, mock_pika_connection):
        ...
        mock_pika_connection.side_effect = Exception("RabbitMQ error")  # Simulate failure
    ...
    def test_message_processing_calls_analyze(self, mock_analyze, mock_consume_messages):
